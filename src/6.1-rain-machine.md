...
Show them: one raindrop sprite, and suddenly it's *raining*. Let the "whoa" moment land. Then dissect it: the original sprite is a **factory**. Each clone is an independent copy that runs its own script.
