...
They build. You help when asked, but resist the urge to take over.
...
## When They Get Stuck — Questions, Not Answers
...
## Quick Reference: Common Patterns They've Learned

These are patterns from earlier units they might need to recall:
...
While watching someone play, they should notice:
- Did they understand what to do without being told?
- Where did they get stuck?
- Was anything too easy or too hard?
- Did anything break?

After the playtest, they pick 2-3 things to fix or improve. This is iteration — the last and most professional step in the engineering process.

### Sharing on Scratch

If they want to share it with the world, they can publish it on the Scratch community site (scratch.mit.edu). Other kids can play it, remix it, and comment on it. This is optional but can be hugely motivating — real people playing their game.
